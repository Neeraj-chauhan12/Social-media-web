  ...
  if (videos.length === 0) {
    return (
      ...
      <div className="h-screen w-screen flex items-center justify-center bg-black text-white text-xl">
        <div>
          <button onClick={() => window.history.back()}  className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 absolute top-2 left-5 text-2xl py-2 px-4 rounded-md border border-gray-700 hover:bg-gray-700  ">back</button>
        </div>
        <div>
            {emptyMessage}
