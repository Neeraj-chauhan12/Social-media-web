  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded border border-gray-300 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-2 rounded border border-gray-300 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              maxLength={100}
            />
          </div>
          <button
        ...
        <button
          onClick={() => navigate("/")}
          className="px-6 w-full py-2 bg-blue-600 text-white rounded font-semibold hover:bg-blue-700"
        >
          Home
        </button>
      </div>
